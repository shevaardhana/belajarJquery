...
$(document).ready(function(){
      menu +='<li class="ui-first-child ui-last-child avatar">'
      menu +='<div class="ui-left" ><img src="./images/user.jpg" class="img-rounded"/></div>'
      menu +='<div class="ui-right"><b>Nama User</b><br><i>email@mail.com</i></div>'
      menu +='</li>'
